  ...
  const links = [
    {
      ...
      href: "#",
      icon: (
        <HiMiniCommandLine className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Profile",
    ...
    },
    {
      ...
      href: "#",
      icon: (
        <IoSettings className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Logout",
